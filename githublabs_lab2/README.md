...
```
githublabs_lab2/data/WA_Fn-UseC_-Telco-Customer-Churn.csv
```
...
> **Important:** The workflow file must live at `.github/workflows/churn_cicd.yml` in the **root** of your repository, not inside `githublabs_lab2/`. GitHub Actions only reads workflows from `.github/workflows/` at the repo root.
